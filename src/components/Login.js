        ...
        <div className="flex justify-between  bg-white rounded-2xl shadow-xl">
          <div className="px-4 border border-black-100">
            <section>
              ...
              <p className="text-sm  text-blue-400 px-8 py-6 pt-2">You  have  been registered  on Barefoot-nomad .Please login with your email and password</p>
            </section>
            <div>
                  ...
                  <form data-testid="form" onSubmit={handleSubmit}>
                    <div className="py-6">
                      <div className="" >
                        ...
                        <TextField isLoaded={loaded} name="email" id="Email" type="text" placeholder="Enter your email" changeValue={handleInput} />
                      </div>
                      <div className="">
                        <TextField isLoaded={loaded} id="Password" name="password" type="password" placeholder="Enter your password" changeValue={handleInput} />
                      </div>
                    </div>
                    <div className="py-6 px-8">

                      {!loaded ? (<Skeleton height={30} />) : (<button id="submit-button" className="bg-indigo-600 text-white justify-center w-full h-8 rounded" type="submit">Login</button>)}
                    </div>
          ...
          <div className="shadow-2xl h-auto hidden md:block">
            {!loaded ? (<Skeleton height={400} />) : (<img src={Image} className=" h-screen block md:block justify-self-start sm:hidden " alt="" />
            )}
          </div>
        </div>
      </div>
