            ...
            <div className="h-auto">
              ...
              <section className="mt-10">
                ...
                <Form>
                  ...
                  <div className="py-6">
                    <button onClick={() => handleSubmit(formik.values)} className="bg-indigo-600 text-white justify-center w-full h-8 rounded" type="submit">Login</button>
                  </div>
                  ...
                  <div className="space-y-5">
                    <div className="flex justify-between rounded border border-blue-600">
                      <div>
                      <img src="https://img.icons8.com/fluent/48/000000/google-logo.png" className="h-6 mt-1 ml-4"/>
                      </div>
