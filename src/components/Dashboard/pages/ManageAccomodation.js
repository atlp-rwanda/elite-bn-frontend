...
import AllAccomodation from '../AllAccomodation'
import ManageAccomodationComp from '../ManageAccomodationComp'

export const ManageAccomodation = ({
  userData,
  GetUserProfile,
  LogoutAction,
  Logout,
...
export default connect(mapStateToProps, mapDispatchToProps)(ManageAccomodation)
