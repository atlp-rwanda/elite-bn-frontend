...
import { FaBell, FaUserEdit, FaGlobe } from 'react-icons/fa'
    ...
    <header className="flex justify-between h-16 align-center shadow-2xl items-center font-mainFont relative  bg-white ">
      <div className="logo  justify-between w-1/4 mr-5 ">
        {size < 760 ? (
          ...
          <h1 className="relative   text-center z-20  text-white  bottom-1">
            Barefoot nomad
            <div className="line w-3/6 left-1/4  text-center bg-white absolute h-0.5 z-20 top-7 " />
          </h1>
        )}
      </div>
            ...
            <div className="profile flex-row flex mr-7">
              <div className="flex-row flex relative">
                ...
                <div>
                  ...
                  >
                    <div className="drop-list flex  py-2 px-4 cursor-pointer hover:bg-gray-500 hover:text-white  items-center ">
                      <div className="drop-item">
                        <IoLogOutOutline className="mt-1" />
                      </div>
                      <div className="drop-item">
                        <span className="text-xs ml-2">Setting</span>
                      </div>
                    </div>
                    ...
                    <div className="flex py-2 px-4 cursor-pointer hover:bg-gray-500 hover:text-white ">
                      ...
                      <div className="drop-item">
                        <span className="text-xs ml-2 cursor-pointer">
                          Logout
                        </span>
                      </div>
                    </div>
