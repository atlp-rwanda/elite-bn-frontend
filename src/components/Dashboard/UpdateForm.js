...
const UpdateForm = ({ userData }) => {
  ...
  const onSubmit = (values) => {
    ...
    axios
      .patch(`http://localhost:5000/api/v1/users/updateProfile/`, data)
      .then((res) => {
      ...
      .catch((error) => {
        ...
        toast.error('Image is required and make sure that it is a jpg,png and jpeg images.');
        setSpinner(!spinner);
      });
  };
    ...
    <>
      {loading ? (
        ...
        <div className="col-start-3    row-start-2  col-end-13 p-4 md:p-12">
          <ToastContainer />
          <h1 className="text-blue-600 font-bold text-xl  md:text-3xl mb-4 w-full  md:w-2/4">
            Update profile
          </h1>
          <Formik
            ...
            {(formProps) => (
              ...
              md:p-0    flex flex-col md:flex-row "
                  ...
                  <div className="names  flex flex-col md:flex-row  ">
                    ...
                    <div className="controlInput w-full md:w-6/12 m-o md:ml-8">
                  ...
                  <div className="names flex flex-col  md:flex-row  mt-2 ">
                    <div className="controlInput w-full md:w-6/12">
                      <label htmlFor="firstName" className="capitalize text-gray-500 pt-2  ">
                        {' '}
                        email{' '}
                      </label>
                    ...
                    <div className="controlInput w-full md:w-6/12  m-0 md:ml-8">
                      <label htmlFor="firstName" className="capitalize text-gray-500 pt-2  ">
                        {' '}
                        Language{' '}
                      </label>
                  ...
                  <div className="names flex flex-col md:flex-row mt-2   ">
                    <div className="controlInput w-full  ">
                      <label htmlFor="firstName" className="capitalize text-gray-500 pt-2  ">
                        {' '}
                        Address{' '}
                      </label>
